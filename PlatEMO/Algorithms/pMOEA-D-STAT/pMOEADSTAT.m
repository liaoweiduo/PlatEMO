...
%--------------------------------------------------------------------------
    ...
    %load existed population from memmapfile
    file = fullfile(fileparts(mfilename('fullpath')),'population.mat');
...
m = memmapfile(filename, 'Writable', true, 'Format', 'double'); %设置好共享内存
    ...
    while Global.NotTermination(Population)
        ...
        for i = 1 : N 
            ...
            [nsf, selectedFeatures] = Global.problem.getSelectedFeatures(Offspring);
            if nsf > nref
