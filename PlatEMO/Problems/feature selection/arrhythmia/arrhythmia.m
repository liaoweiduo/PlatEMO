...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = arrhythmia()
            ...
            file = fullfile(fileparts(mfilename('fullpath')),'arrhythmia.mat');
            if exist(file,'file') == 2
                load(file,'train','test','accuracy');
            else
                fid = fopen('arrhythmia.data','rt');
                FormatString='';
