classdef hillvalley < PROBLEM
% <problem> <feature selection>
% The bi-objective feature selection problem
% 606 instances;2 classes;100 attributes


%------------------------------- Reference --------------------------------
% http://archive.ics.uci.edu/ml/machine-learning-databases/hill-valley/
%------------------------------- Copyright --------------------------------
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = hillvalley()
            ...
            file = fullfile(fileparts(mfilename('fullpath')),'hillvalley.mat');
            if exist(file,'file') == 2
                load(file,'train','test','accuracy');
            else
                fid = fopen('Hill_Valley_without_noise_Training.data','rt');
                FormatString='';
