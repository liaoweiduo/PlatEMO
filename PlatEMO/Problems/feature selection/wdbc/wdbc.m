...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = wdbc()
            ...
            file = fullfile(fileparts(mfilename('fullpath')),'wdbc.mat');
            if exist(file,'file') == 2
                load(file,'train','test','accuracy');
            else
                fid = fopen('wdbc.data','rt');
                FormatString='%f %s';
                for i = 3:obj.Global.D+1
