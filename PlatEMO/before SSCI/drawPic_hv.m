...
%             subplot(2,2,indexM);
            ...
            for i = 1:length(metrics_1)     % origin metrics
                if strcmp(metrics_1(i).Problem, Problem) && strcmp(metrics_1(i).M, M)
                    ...
                    p4=scatter(metrics_2(1).hvSetStrut.indexSet(1:10:end), hvSetStrut.aver(1:10:end));
                    break
                end
            end
            ...
            for i = 1:length(metrics_2)     % dr metrics
                if strcmp(metrics_2(i).Problem, Problem) && strcmp(metrics_2(i).M, M)
                    ...
                    p5=scatter(hvSetStrut.indexSet(1:10:end), hvSetStrut.aver(1:10:end));
                    break
                end
            end
            ...
            for i = 1:length(metrics_3)     % dr2 metrics
                if strcmp(metrics_3(i).Problem, Problem) && strcmp(metrics_3(i).M, M)
                    ...
                    p6=scatter(hvSetStrut.indexSet(1:10:end), hvSetStrut.aver(1:10:end));
                    break
                end
            end
            ...
            for i = 1:length(metrics_4)     % optimal metrics
                if strcmp(metrics_4(i).Problem, Problem) && strcmp(metrics_4(i).M, M)
                    ...
                    p7=scatter(hvSetStrut.indexSet(1:10:end), hvSetStrut.aver(1:10:end));
                    break
                end
            end
            
            try
                legend([p0,p1,p2,p3,p4,p5,p6,p7],'origin','DR','DR2','optimal','origin','DR','DR2','optimal');
            catch exception
            end
