...
\begin{figure}[!t]
  \centering
  \subfloat[Inverted-DTLZ1 with a fixed reference point.]{\label{rpa2:a}
    \includegraphics[width=1.5in]{FVEMOA_fixrp_IDTLZ1_evaluation20000_r1__1}}\quad
  \subfloat[Inverted-DTLZ1 with a adapted reference point.]{\label{rpa2:b}
  \includegraphics[width=1.5in]{FVEMOA_IDTLZ1_evaluation20000_r1__1}}\\
  \subfloat[DTLZ1 with a fixed reference point.]{\label{rpa2:c}
    \includegraphics[width=1.5in]{FVEMOA_fixrp_DTLZ1_evaluation20000_r1__1}}\quad
  \subfloat[DTLZ1 with a adapted reference point.]{\label{rpa2:d}
  \includegraphics[width=1.5in]{FVEMOA_DTLZ1_evaluation20000_r1__1}}\\
  \caption{The final distribution of solutions set in inverted-DTLZ1(\ref{rpa2:a} and \ref{rpa2:b}) 
  and DTLZ1 problem(\ref{rpa2:c} and \ref{rpa2:d}).
  The algorithm is FVEMOA with population size $= 100$, evaluation number $= 20000$ and $r=1.1$. 
