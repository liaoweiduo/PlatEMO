...
\begin{figure}[!t]
  ...
  The algorithm is SMS-EMOA with population size $= 100$, evaluation number $= 20000$ and $r=1.1$. 
...
$r$ is specified as %SMSEMOA是固定正无穷， 现在用的算法在platEMO是用1.1. hypE用， FV-EMOA用，  都不同， common 1.1
